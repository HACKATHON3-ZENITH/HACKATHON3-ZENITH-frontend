...
export function LoginForm({ onSubmit, onGoogleLogin, onToggleRegister, isLoading, error }: LoginFormProps) {
  const {
    register,
    handleSubmit,
    formState: { errors },
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <a href="#" className="text-xs font-bold text-[#0D5C4D] hover:underline">Mot de passe oublié ?</a>
          </div>
          <input
            {...register('password')}
            type="password"
